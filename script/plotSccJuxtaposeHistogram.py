...
# fourth argument: chatgpt ternary operator file
# fifth argument: human ternary operator file
# Examples:
# python3 script_name.py complexity scc_chatgpt.txt scc_human.txt ternary_chatgpt.txt ternary_human.txt
# python3 script_name.py complexity/code scc_chatgpt.txt scc_human.txt ternary_chatgpt.txt ternary_human.txt
...
def plot_data(file_data1, file_data2, ternary_1, ternary_2, metric):
    ...
    ax.set_title(f'DS & Algorithm {metric.capitalize()} by file (sorted based on ChatGPT-4o)')
    ax.set_xticks(x)
